...
function LoginContent() {
  ...
  const getErrorMessage = (errorCode: string | null): string | null => {
    switch (errorCode) {
      case 'AccessDenied':
        return 'Access Denied: Your email is not authorized to access this admin panel. Contact the administrator if you believe this is an error.';
      case 'Configuration':
      ...
      case 'NoEmail':
        return 'Could not retrieve email from your Google account.';
      case 'AuthError':
        return 'An authentication error occurred. Please try again.';
      case 'OAuthCallback':
        return 'OAuth callback error. Please try again or contact support.';
      case 'OAuthSignin':
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isLoading ? (
          ...
          <div className="px-8 py-4 bg-gray-50 border-t border-gray-100">
            <div className="flex items-center justify-center gap-2 text-xs text-gray-400">
              ...
              <span>Secured with strict email allowlist verification</span>
            </div>
          </div>
        </div>
